...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--search", nargs = '*', metavar = "book, keyword", type = str, help = "Returns verses (and the verses proximate to them) which contain the keyword argument")
